...
OPENCV_MODULES:=contrib stitching nonfree superres ocl ts videostab photo objdetect legacy video ml calib3d features2d highgui imgproc flann androidcamera core
...
ifeq ($(OPENCV_LIB_TYPE),SHARED)
    ...
    ifeq ($(TARGET_ARCH_ABI),armeabi-v7a)
        ...
        OPENCV_EXTRA_COMPONENTS:=/Users/liwendong/tools/adt-bundle/sdk/ndk-bundle/platforms/android-21/arch-arm/usr/lib/libz.so log m dl
    endif
    ifeq ($(TARGET_ARCH_ABI),arm64-v8a)
        OPENCV_3RDPARTY_COMPONENTS:=libjpeg libpng libtiff libjasper IlmImf
        OPENCV_EXTRA_COMPONENTS:=/Users/liwendong/tools/adt-bundle/sdk/ndk-bundle/platforms/android-21/arch-arm/usr/lib/libz.so log m dl
