...
//==============================================================================
/*
 * THIS HEADER FILE IS COPIED FROM HEXAGON-NN 1.12.0 PROJECT
 *
 */
//==============================================================================
 ...
 * @param[in] numOfStaticParams Number of static params defined by the op
 * @param[in] staticParams Array of static params to the op
 * @param[in] numOfInputs Number of input tensors to the op
 ...
 * @param[in] numOfOutputs Number of output tensors to the op
